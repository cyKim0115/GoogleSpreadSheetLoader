...
* [Google SpreadSheet Loader](README.md)

## Getting started

* [설치](getting-started/install.md)
* [서비스 계정 설정](getting-started/service-account.md)
* [첫 다운로드](getting-started/first-download.md)

## Concepts

* [데이터 흐름](concepts/data-flow.md)
* [시트 형식](concepts/sheet-formats.md)
* [생성물과 금지 사항](concepts/generated-outputs.md)

## How-to

* [시트 서식 맞추기](how-to/sheet-formatting.md)
